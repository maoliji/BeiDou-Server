/*
	未来东京 BOSS3 尼贝隆远征队NPC
	适配：北斗GMS083 服务端
	参考：2030013.js 扎昆远征NPC逻辑
	修改：增加地图检测，位于802000611 作为出口，位于802000602 执行远征队功能
*/
...
function action(mode, type, selection) {
    ...
    em = cm.getEventManager("Tokyo3");  //调用event脚本名称

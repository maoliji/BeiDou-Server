...
var entryMap = 802000611;    // 战斗地图
var exitMap = 802000602;     // 退出后返回地图
var recruitMap = 802000602;  // 远征队招募地图（NPC所在）
var clearMap = exitMap;      // 通关后返回地图

var minMapId = 802000611;
var maxMapId = 802000611;
...
function clearPQ(eim) {
    ...
    eim.dropMessage(5, "[远征队] 恭喜！你们成功击败了尼贝隆！");
    eim.startEventTimer(300000); // 通关后5分钟强制清场，注意此时无法重连
}

function isTokyoBoss(mob) {
    return mob.getId() == 9400273;  //BOSSID 尼贝隆第三阶段
}

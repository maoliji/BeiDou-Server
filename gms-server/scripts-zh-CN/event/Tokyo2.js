...
var entryMap = 802000410;    // 战斗地图
var exitMap = 802000500;     // 退出后返回地图
var recruitMap = 802000500;  // 远征队招募地图（NPC所在）
var clearMap = exitMap;      // 通关后返回地图

var minMapId = 802000410;
var maxMapId = 802000410;
...
function clearPQ(eim) {
    ...
    eim.dropMessage(5, "[远征队] 恭喜！你们成功击败了都纳斯！");
    eim.startEventTimer(300000); // 通关后5分钟强制清场，注意此时无法重连
}

function isTokyoBoss(mob) {
    return mob.getId() == 9400270;  //BOSSID 都纳斯
}

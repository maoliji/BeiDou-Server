...
function enter(pi) {
    ...
    // 3. 检查地图211060601是否有人
    var bossMap = pi.getMap(211060601);
    ...
    //if(pi.hasItem(4032834)) {
    //pi.gainItem(4032834, -1);}  // 不扣掉第三座塔的钥匙
    ...
    // ======================
    if (party != null) {
        var Map1 = pi.getMap(211060601);
        Map1.resetFully();
        pi.warpParty(211060601, 1); // 组队传送全队
    } else {
        var Map2 = pi.getMap(211060601);
        Map2.resetFully();
        pi.warp(211060601, 1); // 单人传送自己
    }

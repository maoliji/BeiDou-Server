...
const exped = ExpeditionType.CHAOS_HORNTAIL; // 北斗083无独立的狮子王远征类型，复用进阶黑龙类型（不影响功能，默认不限次数）
var expedName = "狮子王 班·雷昂";
var expedBoss = "班·雷昂";
var expedMap = "狮子王的接见室";
var expedItem = null; // 狮子王无需入场道具，设为null
// =====================================
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (player.getLevel() < 175) {
            cm.sendOk("您的等级不符合挑战" + expedBoss + "的条件！需要至少175级。");
            cm.dispose();

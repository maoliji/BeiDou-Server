...
function init() {
    /*
        ...
        // 澳大利亚东部标准时间(AEST)
        timer1 = em.scheduleAtTimestamp("start", 1779691800000); // 在给定的时间戳启动活动
        timer2 = em.scheduleAtTimestamp("stop", 1779692400000); // 在给定的时间戳停止活动
        // 美国东部夏令时(EDT)
        timer3 = em.scheduleAtTimestamp("start", 1779692700000);
        timer4 = em.scheduleAtTimestamp("stop", 1779693000000);
    }
    */    
}
...
function stop() {
    ...
    world.setExpRate(1); // 将经验值恢复到原来的4倍（正常情况下）
